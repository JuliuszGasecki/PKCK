        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="A4">
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block linefeed-treatment="preserve" text-align="center" font-weight="bold" font-size="12px">Report generated:</fo:block>
                    ...
                    <fo:table table-layout="fixed" border-width="1mm" space-before="10pt" space-after="20pt">
                        ...
                        <fo:table-body>
                            <xsl:for-each select="report/game">
                                <fo:table-row>
                                    <fo:table-cell border="1px solid black" font-size="10px">
                                        <fo:block text-align="center">
                    ...
                    <fo:table table-layout="fixed" border-width="1mm" space-before="10pt">
                        <fo:table-column column-width="50%" />
                        <fo:table-column column-width="50%" />
                        <fo:table-header text-align="center" background-color="silver">
                            <fo:table-row>
                                <fo:table-cell border="1px solid black">
                                    <fo:block text-align="center" font-weight="bold" width="30mm" font-size="10px">Name</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1px solid black">
                                    <fo:block text-align="center" font-weight="bold" width="30mm" font-size="10px">Value</fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                        </fo:table-header>
                        <fo:table-body>
                    ...
                    <fo:table table-layout="fixed" border-width="1mm" space-before="10pt">
                        ...
                        <fo:table-header text-align="center" background-color="silver">
                            <fo:table-row>
                                <fo:table-cell border="1px solid black">
                                    <fo:block text-align="center" font-weight="bold" width="30mm" font-size="10px">Genre</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1px solid black">
                                    <fo:block text-align="center" font-weight="bold" width="30mm" font-size="10px">Number of games</fo:block>
                                </fo:table-cell>
                            </fo:table-row>
                        </fo:table-header>
                        <fo:table-body>
                    ...
                    <fo:table table-layout="fixed" border-width="1mm" space-before="10pt">
                        ...
                        <fo:table-header text-align="center" background-color="silver">
                            <fo:table-row>
                                <fo:table-cell border="1px solid black">
                                    <fo:block text-align="center" font-weight="bold" width="30mm" font-size="10px">Rating</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1px solid black">
                                    <fo:block text-align="center" font-weight="bold" width="30mm" font-size="10px">Number of games</fo:block>
                                </fo:table-cell>
                    ...
                    <fo:table table-layout="fixed" border-width="1mm" space-before="10pt">
                        ...
                        <fo:table-header text-align="center" background-color="silver">
                            <fo:table-row>
                                <fo:table-cell border="1px solid black">
                                    <fo:block text-align="center" font-weight="bold" width="30mm" font-size="10px">Producer name</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1px solid black">
                                    <fo:block text-align="center" font-weight="bold" width="30mm" font-size="10px">Number of games</fo:block>
                                </fo:table-cell>
